...
use Services\Providers\{CommandServiceProvider, EventServiceProvider, SchedulerServiceProvider, QueueServiceProvider};
...
class Container
{
    ...
    public static function bind(): ContainerBuilder
    {
        ...
        self::$container->register('command.serviceProvider', CommandServiceProvider::class)
            ->setPublic(true);

        // Register Hm_QueueServiceProvider
        self::$container->register('queue.ServiceProvider', QueueServiceProvider::class)
            ->setPublic(true);

        self::$container->register('scheduler.ServiceProvider', SchedulerServiceProvider::class)
            ->setPublic(true);

        self::$container->register('event.ServiceProvider', EventServiceProvider::class)
            ->setPublic(true);
