...
class Hm_Output_add_pop3_server_dialog extends Hm_Output_Module {
    ...
    protected function output() {
        ...
        return '<div class="pop3_server_setup"><div data-target=".pop3_section" class="server_section">'.
            ...
            '<input required type="text" id="new_pop3_name" name="new_pop3_name" class="txt_fld form-control" value="" placeholder="'.$this->trans('Account name').'" /></td></tr>'.
            '<tr><td colspan="2"><label class="screen_reader" for="new_pop3_address">'.$this->trans('POP3 server address').'</label>'.
            '<input required type="text" id="new_pop3_address" name="new_pop3_address" class="txt_fld form-control" placeholder="'.$this->trans('POP3 server address').'" value=""/></td></tr>'.
