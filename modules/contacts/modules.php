...
class Hm_Output_contact_auto_collect_setting extends Hm_Output_Module {
    protected function output() {
        ...
        return '<tr class="general_setting"><td><div class="d-flex flex-column flex-md-row"><span class="fw-bold me-md-3"><label for="contact_auto_collect">' .
            $this->trans('Automatically add outgoing email addresses') . '</label></span><div><input class="form-check-input" type="checkbox" ' . $checked . ' id="contact_auto_collect" name="contact_auto_collect" data-default-value="true" value="1" />' . $reset . '</div></div></td></tr>';
    }
}
...
class Hm_Output_enable_collect_address_on_send_setting extends Hm_Output_Module {
    ...
    protected function output() {
        ...
        return '<tr class="general_setting"><td><div class="d-flex flex-column flex-md-row"><span class="fw-bold me-md-3"><label class="form-check-label" for="enable_collect_address_on_send">'.
            $this->trans('Enable collect address on send').'</label></span><div><input class="form-check-input" type="checkbox" '.$checked.
            ' value="1" id="enable_collect_address_on_send" name="enable_collect_address_on_send" data-default-value="'.(DEFAULT_ENABLE_COLLECT_ADDRESS_ON_SEND ? 'true' : 'false') . '"/>'.$reset.'</div></div></td></tr>';
    }
}
...
class Hm_Output_enable_warn_contacts_cc_not_exist_in_list_contact extends Hm_Output_Module {
    protected function output() {
        ...
        return '<tr class="general_setting"><td><div class="d-flex flex-column flex-md-row"><span class="fw-bold me-md-3"><label class="form-check-label" for="enable_warn_contacts_cc_not_exist_in_list_contact">'.
            $this->trans('Enable warn if contacts Cc not exist in list contact').'</label></span><div><input class="form-check-input" type="checkbox" '.$checked.
            ' value="1" id="enable_warn_contacts_cc_not_exist_in_list_contact" name="enable_warn_contacts_cc_not_exist_in_list_contact" />'.$reset.'</div></div></td></tr>';
    }
}
