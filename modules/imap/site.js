...
get_list_block_sieve(Hm_Utils.parse_folder_path(hm_list_path()));

function get_list_block_sieve(detail) {
        ...
        Hm_Ajax.request(
            ...
            function (res) {
                if (res.ajax_list_block_sieve) {
                    list_blocked_senders = JSON.parse(res.ajax_list_block_sieve);
                }
            }
        );
    }
