...
add_handler('ajax_imap_mark_as_read', 'save_imap_servers',  true, 'imap', 'imap_mark_as_read', 'after');
...
add_handler('ajax_message_action', 'save_imap_servers',  true, 'imap', 'imap_message_action', 'after');
