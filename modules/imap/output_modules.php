...
class Hm_Output_setting_enable_snooze extends Hm_Output_Module {
    protected function output() {
        ...
        return '<tr class="general_setting"><td class="d-block d-md-table-cell"><label for="enable_snooze">'.
            $this->trans('Enable Snooze functionality').'</label></td><td class="d-block d-md-table-cell"><div class="d-flex align-items-center"><input class="form-check-input me-2" type="checkbox" '.$checked.' id="enable_snooze" name="enable_snooze" data-default-value="'.(DEFAULT_ENABLE_SNOOZE ? 'true' : 'false') . '" value="1" />'.$reset.'</div></td></tr>';
    }
}
