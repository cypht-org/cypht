...
class Hm_Output_filter_message_headers extends Hm_Output_Module {
      protected function output() {
        if ($this->get('msg_headers')) {
            ...
            if (isset($headers['Flags']) && mb_stristr($headers['Flags'], 'flagged')) {
                $txt .= '<a class="flagged_link hlink text-decoration-none hide" id="flag_msg" data-state="unflagged" href="#">'.$this->trans('Flag').'</a>';
                $txt .= '<a id="unflag_msg" class="flagged_link hlink text-decoration-none" data-state="flagged" href="#">'.$this->trans('Unflag').'</a>';
            } else {
                $txt .= '<a id="flag_msg" class="unflagged_link hlink text-decoration-none" data-state="unflagged" href="#">'.$this->trans('Flag').'</a>';
                $txt .= '<a class="flagged_link hlink text-decoration-none hide" id="unflag_msg" data-state="flagged" href="#">'.$this->trans('Unflag').'</a>';
            }
