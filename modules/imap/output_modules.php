        ...
        if ($this->get('custom_list_controls_type')) {
            ...
            if ($this->get('folder')) {
                if ($this->get('screen_emails')) {
                    $custom .= '<a title="Like" href="#" id="screen-email-unlike"><i class="bi bi-hand-thumbs-down-fill"></i></a><a title="Dislike" href="#" id="screen-email-like"></i><i class="bi bi-hand-thumbs-up-fill"></i></a>';
                } else {
