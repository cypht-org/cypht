...
class Hm_Output_setting_enable_snooze extends Hm_Output_Module {
    protected function output() {
        ...
        return '<tr class="general_setting"><td><div class="d-flex flex-column flex-md-row"><span class="fw-bold me-md-3"><label class="form-check-label" for="enable_snooze">'.
            $this->trans('Enable Snooze functionality').'</label></span><div><input class="form-check-input" type="checkbox" '.$checked.' id="enable_snooze" name="enable_snooze" data-default-value="'.(DEFAULT_ENABLE_SNOOZE ? 'true' : 'false') . '" value="1" />'.$reset.'</div></div></td></tr>';
    }
}
