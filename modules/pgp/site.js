...
var Hm_Pgp = {
    ...
    update_private_keys: function(key) {
        if (!Hm_Pgp.validate_private_key(key)) {
            Hm_Utils.add_sys_message('Unable to import private key', 'danger');
            return;
        }
        ...
        Hm_Utils.add_sys_message('Private key saved', 'success');
    },
    ...
    delete_private_key: function(del_index) {
        if (hm_delete_prompt()) {
            ...
            Hm_Utils.add_sys_message('Private key removed', 'info');
            Hm_Pgp.list_private_keys();
        }
    },
