...
class Hm_Spam_Reporting_Manager {
    ...
    /** @var array adapter_id => Hm_Spam_Report_Target_Interface */
    ...
    /**
     * Build adapters from spam_reporting_allowed_target_types.
     */
    ...
    /**
     * Get effective targets then filter by user settings and optionally by is_available($report).
     * Returns only public fields for UI .
