...
return array(
    ...
    'allowed_output' => array(
        'feed_connect_status' => array(FILTER_SANITIZE_FULL_SPECIAL_CHARS, false),
    ...
    'allowed_post' => array(
        ...
        'feed_server_ids' => FILTER_SANITIZE_FULL_SPECIAL_CHARS,
        'submit_feed' => FILTER_SANITIZE_FULL_SPECIAL_CHARS,
        'new_feed_name' => FILTER_SANITIZE_FULL_SPECIAL_CHARS,
        'feed_delete' => FILTER_VALIDATE_INT,
        'new_feed_address' => FILTER_SANITIZE_FULL_SPECIAL_CHARS,
        'unread_exclude_feeds' => FILTER_VALIDATE_INT,
        'feed_list_path' => FILTER_SANITIZE_FULL_SPECIAL_CHARS,
        'feed_uid' => FILTER_SANITIZE_FULL_SPECIAL_CHARS,
        'feed_since' => FILTER_SANITIZE_FULL_SPECIAL_CHARS,
