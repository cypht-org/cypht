...
function blockListPageHandlers() {
    ...
    $("#sieve_accounts").on('click', '.submit_default_behavior', function(e) {
        e.preventDefault();
    ...
    $("#sieve_accounts").on('click', '.unblock_button', function(e) {
        e.preventDefault();
    ...
    $("#sieve_accounts").on('click', '.edit_blocked_behavior', function(e) {
        e.preventDefault();
    ...
    $("#sieve_accounts").on('click', '.block_domain_button', function(e) {
        e.preventDefault();
        let sender = $(this).parent().parent().children().html();
        let elem = $(this);
        Hm_Ajax.request(
    ...
    $("#sieve_accounts").on('click', '.edit_email_behavior_submit', function(e) {
        e.preventDefault();
        let sender = $(this).parent().parent().children().html();
        let elem = $(this);
        Hm_Ajax.request(
