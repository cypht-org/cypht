...
return array(
    'allowed_post' => array(
        'ldap_first_name' => FILTER_DEFAULT,
        'ldap_last_name' => FILTER_DEFAULT,
        'ldap_displayname' => FILTER_DEFAULT,
        'ldap_mail' => FILTER_DEFAULT,
        'ldap_locality' => FILTER_DEFAULT,
        'ldap_state' => FILTER_DEFAULT,
        'ldap_street' => FILTER_DEFAULT,
        'ldap_postalcode' => FILTER_DEFAULT,
        'ldap_title' => FILTER_DEFAULT,
        'ldap_phone' => FILTER_DEFAULT,
        'ldap_fax' => FILTER_DEFAULT,
        'ldap_mobile' => FILTER_DEFAULT,
        'ldap_room' => FILTER_DEFAULT,
        'ldap_car' => FILTER_DEFAULT,
        'ldap_org' => FILTER_DEFAULT,
        'ldap_org_unit' => FILTER_DEFAULT,
        'ldap_org_dpt' => FILTER_DEFAULT,
        'ldap_emp_num' => FILTER_DEFAULT,
        'ldap_emp_type' => FILTER_DEFAULT,
        'ldap_lang' => FILTER_DEFAULT,
        'ldap_uri' => FILTER_DEFAULT,
        'add_ldap_contact' => FILTER_DEFAULT,
        'update_ldap_contact' => FILTER_DEFAULT,
        'ldap_source' => FILTER_DEFAULT,
        'ldap_usernames' => array('filter' => FILTER_DEFAULT, 'flags'  => FILTER_FORCE_ARRAY),
