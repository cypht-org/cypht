                        ...
                        <div id="step_config_1" class="step step_config">
                            ...
                            <div>
                                <form class=" me-0" method="POST">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input required type="text" id="srv_setup_stepper_email" name="srv_setup_stepper_email" class="txt_fld form-control" autocomplete="username" value="" placeholder="'.$this->trans('Email or Username').'">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input required type="password" id="srv_setup_stepper_password" name="srv_setup_stepper_password" autocomplete="current-password" class="txt_fld form-control" value="" placeholder="'.$this->trans('Password').'">
