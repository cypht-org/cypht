...
add_handler('home', 'default_page_data', true);
...
add_handler('servers', 'default_page_data', true);
...
add_handler('compose', 'default_page_data', true);
...
add_handler('settings', 'default_page_data', true);
...
add_handler('search', 'default_page_data', true);
...
add_handler('help', 'default_page_data', true);
...
add_handler('bug_report', 'default_page_data', true);
...
add_handler('dev', 'default_page_data', true);
...
add_handler('profiles', 'default_page_data', true);
...
add_handler('message_list', 'default_page_data', true);
...
add_handler('message', 'default_page_data', true);
...
add_handler('notfound', 'default_page_data', true);
