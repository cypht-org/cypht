...
add_output('servers', 'zepto', false);
...
add_output('compose', 'zepto', false);
...
add_output('settings', 'zepto', false);
...
add_output('bug_report', 'zepto', false);
...
add_output('profiles', 'zepto', false);
...
add_output('message_list', 'zepto', false);
...
add_output('message', 'zepto', false);
...
add_output('notfound', 'zepto', false);
