...
class Hm_Output_contacts_form extends Hm_Output_Module {
    protected function output() {
        ...
        return '<div class="add_contact"><form class="add_contact_form" method="POST">'.
            ...
            '<input onkeyup="contact_phone_verify()" onchange="contact_phone_verify()" placeholder="'.$this->trans('Telephone Number').'" id="contact_phone" type="text" name="contact_phone" '.
