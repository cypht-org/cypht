...
return array(
    ...
    'allowed_output' => array(
        ...
        'github_status_repo' => array(FILTER_UNSAFE_RAW, false),
    ),
    'allowed_post' => array(
        'github_unread' => FILTER_VALIDATE_INT,
        'github_since' => FILTER_UNSAFE_RAW,
        'github_limit' => FILTER_VALIDATE_INT,
        'github_uid' => FILTER_UNSAFE_RAW,
        'github_disconnect' => FILTER_UNSAFE_RAW,
        'new_github_repo_owner' => FILTER_UNSAFE_RAW,
        'new_github_repo' => FILTER_UNSAFE_RAW,
        'github_remove_repo' => FILTER_UNSAFE_RAW,
        'github_add_repo' => FILTER_UNSAFE_RAW,
        'github_repo' => FILTER_UNSAFE_RAW,
        'github_force_refresh' => FILTER_VALIDATE_INT,
