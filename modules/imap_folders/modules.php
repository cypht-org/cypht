...
class Hm_Output_imap_only_subscribed_folders_setting extends Hm_Output_Module {
    protected function output() {
        ...
        return '<tr class="general_setting"><td><div class="d-flex flex-column flex-md-row"><span class="fw-bold me-md-3"><label for="only_subscribed_folders">'.
            $this->trans('Showing subscribed folders only').'</label></span><input type="checkbox" '.$checked.' id="only_subscribed_folders" name="only_subscribed_folders" data-default-value="false" value="1" class="form-check-input" />'.$reset.'</div></td></tr>';
    }
}
