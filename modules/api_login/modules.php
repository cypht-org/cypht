...
class Hm_Handler_api_login_step_two extends Hm_Handler_login {
    public function process() {
        ...
        $same_site = $this->session->same_site_policy($this->request, 'Lax');
        Hm_Functions::setcookie('hm_id', stripslashes($form['hm_id']), 0, $path, $domain, $secure, true, $same_site);
        Hm_Functions::setcookie($this->session->get_cookie_name(), stripslashes($form['hm_session']), 0, $path, $domain, $secure, true, $same_site);
