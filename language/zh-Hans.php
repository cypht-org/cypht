...
return array(
    ...
    'Show feed items received since' => '显示多长时间的 Feed',
    ...
    'Messages moved' => '邮件已移动',
    'Messages copied' => '邮件已复制',
    ...
    'Jump to the Compose page' => '跳转到编辑页面',
    ...
    "This phone number appears to contain invalid character (s).\nIf you are sure ignore this warning and continue!" => '检测到电话号码中包含潜在的非法字符。是否忽略本警告并继续？',
    'Server Error' => '服务器错误',
    'Close' => '关闭',
