...
return array(
    ...
    'Add a POP3 Server' => '添加 POP3 服务器',
    'POP3 account name' => 'POP3 账号名称',
    ...
    'Cypht is a webmail program. You can use it to access your E-mail accounts from any service that offers IMAP, POP3, or SMTP access - which most do.' => 'Cypht 是一款网络邮件程序。它可用于访问需要 IMAP、POP3 和 SMTP 服务的电子邮件账户（主要是这些服务）。',
    'Quickly add an account from popular E-mail providers. To manually configure an account, use the IMAP/SMTP/POP3 sections below.' => '立即为常用电子邮件服务添加账户。要手动设置账户，请使用下面的 IMAP/SMTP/POP3 部分。',
    ...
    'POP3 server added' => 'POP3服务器添加',
    'POP3 server saved' => 'POP3服务器保存',
